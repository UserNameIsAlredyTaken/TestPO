...
public class CannotGoToAccount {
...
//        driver.findElement(By.xpath("(.//*[@data-test-id='submit-button'])")).click();
    ...
    public void testAnswer() throws Exception {
        driver.findElement(By.xpath("//*[@bem-id='205']")).click();

        assertFalse(isElementPresent(By.xpath("//*[@class='pm-toolbar__button__icon__img  pm-toolbar__button__icon__img_notext pm-toolbar__button__icon__img_avatar pm-toolbar__button__avatar']")));
    }
