...
public class Edit {
  ...
  public void testEdit() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Не могу определиться с жизненным путём, что сейчас перспективнее?'])[1]/following::span[1]")).click();
    ...
    driver.findElement(By.linkText("Сохранить вопрос")).click();
  }
